...
- Material 3 theme with centralized colors/typography
- `go_router` route map for auth flow and internal navigation
- Bottom navigation shell for Home, Nutrition, Exercise, Progress, and AI Coach
- Professional placeholder screens and shared UI components for rapid iteration
